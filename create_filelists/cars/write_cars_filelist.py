...
data_path = join('/data/pikey/dataset/FewshotData/cars/Stanford_Cars/cars_train')

savedir = './'
dataset_list = ['base','val','novel']

data_list = np.array(loadmat('/data/pikey/dataset/FewshotData/cars/Stanford_Cars/devkit/cars_train_annos.mat')['annotations'][0])
class_list = np.array(loadmat('/data/pikey/dataset/FewshotData/cars/Stanford_Cars/devkit/cars_meta.mat')['class_names'][0])
